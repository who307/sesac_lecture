...
console.log(`판매 가능: ${productIsAvailable}`);
console.log(`상품명 타입: ${typeof productName}`);
console.log(`가격 타입: ${typeof productPrice}`);
console.log(`판매 가능 타입: ${typeof productIsAvailable}`);
...
let transInputPrice = Number(inputPrice);
let transInputDeliveryFee = Number(inputDeliveryFee);

console.log(`총 결제 금액: ${transInputPrice + transInputDeliveryFee}`);
console.log(`합계 타입: ${typeof (transInputPrice + transInputDeliveryFee)}`);
/*;
======================================================================
...
if (score < 0 || score > 100) {
    console.log(`${score} -> 점수를 확인하세요.`);
} else if (score >= 90) {
    console.log(`${score} -> 우수`);
